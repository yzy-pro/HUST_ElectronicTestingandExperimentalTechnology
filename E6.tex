...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{e6docx_media/media/image1.jpeg}
    \caption{逻辑门主要参数参考图}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{e6docx_media/media/image2.png}
    \caption{下拉电阻测 $V_{OH}$}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{e6docx_media/media/image3.png}
    \caption{上拉电阻测 $V_{OL}$}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{e6docx_media/media/image4.png}
    \caption{传输延迟测试电路}
\end{figure}
...
\section{硬件实验结果分析}
\subsection{集成逻辑门电路参数测试}
\subsubsection{实验插板与波形}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{e6docx_media/media/image5.jpeg}
    \caption{测量 $V_{OH}$ 与 $V_{OL}$ 插板图}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{e6docx_media/media/image6.jpeg}
    \caption{传输延迟测试插线图}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{e6docx_media/media/image7.png}
    \caption{上升沿延迟波形}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{e6docx_media/media/image8.png}
    \caption{下降沿延迟波形}
\end{figure}
...
\begin{table}[H]
\centering
\caption{$V_{OH}$ 测试数据（电源 5.09V）}
\begin{tabular}{|c|c|c|c|}
\hline
测试条件 & 空载 & 接510$\Omega$电阻 & 接5.1k$\Omega$电阻 \\
\hline
电压 & 20.0mV & 4.71V & 5.06V \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{$V_{OL}$ 测试数据（电源 5.09V）}
\begin{tabular}{|c|c|c|c|}
\hline
测试条件 & 空载 & 接510$\Omega$电阻 & 接5.1k$\Omega$电阻 \\
\hline
电压 & 5.07V & 0.321V & 32.6mV \\
\hline
\end{tabular}
\end{table}
